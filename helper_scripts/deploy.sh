...
BUCKET_NAME="aws-cloudtrail-logs-658192556205-087cd9bb" # bucket must exist in the SAME region the deployment is taking place
...
info_sec_ops_mail="ragulmuthusami03@gmail.com"
